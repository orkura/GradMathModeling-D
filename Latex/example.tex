...
\baominghao{\hspace{6em} 26106190022} %参赛队号
\schoolname{\hspace{5.8em} 西南科技大学} %学校名称
\membera{\hspace{6em} 罗财能} %队员A
\memberb{\hspace{6em} 龙昌淇} %队员B
\memberc{\hspace{6em} 李业展} %队员C
